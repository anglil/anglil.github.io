...
def transcribe_pdfs():
    ...
    for pdf_path, ch_name in pdf_files:
        ...
        for page_num in range(len(doc)):
            ...
            prompt = """You are a meticulous textbook transcriber converting a student's handwritten engineering notebook into a professional textbook chapter.
1. Extract and translate all Chinese text into fluent, highly cohesive English prose. Ensure sentences flow logically as a textbook.
2. Preserve all mathematical formulas, equations, and code snippets exactly. Wrap inline math in $...$ and block math in $$...$$.
3. CRITICAL: Completely IGNORE and do not transcribe notebook covers, personal information (e.g., Name, Address, Tel, "REPORT PAD", "Maslino"), bindings, or blank pages. If a page only contains notebook cover text, return nothing.
4. Output only the extracted and cohesive English text, code, and math."""
            ...
            # If the output is empty or very short after ignoring covers, skip it
