...
os.makedirs("college-computer-engineering/images/diagrams", exist_ok=True)

diagrams = glob.glob("diagram_crops_ce2/*.png")
diagrams.sort()

for diag in diagrams:
    basename = os.path.basename(diag)
    shutil.copy(diag, f"college-computer-engineering/images/diagrams/{basename}")

for ch_num in range(1, 6):
    html_file = f"college-computer-engineering/ch{ch_num:02d}.html"
