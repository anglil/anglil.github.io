...
with sync_playwright() as p:
    ...
    for i, url in enumerate(urls):
        ...
        try:
            ...
            title = page.title()
            html_content = page.evaluate("document.getElementById('mainContent') ? document.getElementById('mainContent').outerHTML : document.body.innerHTML")
